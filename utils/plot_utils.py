...
def format_plot(mi_estimate="", figure_choice="4", is_independent=False, N_value=1, distribution_name='gaussian', 
    ...
    if figure_choice=="4b":
        plt.xlabel(r"Number of non-zero cells" if mi_estimate == "mi_binning" else "k", fontsize=25)
    elif figure_choice in ["4", "4c"]: 
        plt.xlabel(r"Number of non-zero cells/N" if mi_estimate == "mi_binning" else "k/N", fontsize=25)
    elif figure_choice in ["20", "7", "9"]:
        plt.xlabel(r"1/N", fontsize=25)
    elif figure_choice=="8":

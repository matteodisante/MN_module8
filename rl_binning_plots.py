...
def import_all_data(n, h, k):
    # A files
    file_path1 = f'data/real_data/n_{n}/h_{h}/binning/k_bins_{k}/A/mi_A14F3-TE10034.txt'
    data1 = import_data(file_path1)

    file_path2 = f'data/real_data/n_{n}/h_{h}/binning/k_bins_{k}/A/mi_A14F4-TE10034.txt'
    data2 = import_data(file_path2)

    file_path3 = f'data/real_data/n_{n}/h_{h}/binning/k_bins_{k}/A/mi_A15F3-TE10034.txt'
    data3 = import_data(file_path3)

    file_path4 = f'data/real_data/n_{n}/h_{h}/binning/k_bins_{k}/A/mi_A15F4-TE10034.txt'
    data4 = import_data(file_path4)

    file_path5 = f'data/real_data/n_{n}/h_{h}/binning/k_bins_{k}/A/mi_A16F3-TE10034.txt'
    data5 = import_data(file_path5)

    # C files
    file_path6 = f'data/real_data/n_{n}/h_{h}/binning/k_bins_{k}/C/mi_C11F3-VE.txt'
    data6 = import_data(file_path6)

    file_path7 = f'data/real_data/n_{n}/h_{h}/binning/k_bins_{k}/C/mi_C11F4-VE.txt'
    data7 = import_data(file_path7)

    file_path8 = f'data/real_data/n_{n}/h_{h}/binning/k_bins_{k}/C/mi_C12F3-VE.txt'
    data8 = import_data(file_path8)

    file_path9 = f'data/real_data/n_{n}/h_{h}/binning/k_bins_{k}/C/mi_C13F3-VE.txt'
    data9 = import_data(file_path9)

    file_path10 = f'data/real_data/n_{n}/h_{h}/binning/k_bins_{k}/C/mi_C13F4-VE.txt'
...
def hist_2labels(n, h, k, data1, data2, label1, label2, directory_path):
    ...
    if title == 0:
        ...
        plot_title = f'n_{n}/h_{h}/binning/k_bins_{k}'
...
def same_mouse_diff_phase(n, h, k, data):
    ...
    directory_path = f'data/real_data/plots/n_{n}/h_{h}/binning/k_bins_{k}/same_mouse_diff_phase'
...
def diff_mouses_same_class(n, h, k, data):
    ...
    directory_path = f'data/real_data/plots/n_{n}/h_{h}/binning/k_bins_{k}/diff_mouses_same_class'
    ensure_directory_exists(directory_path)
...
def diff_mouses_diff_classes(n, h, k, data):
    ...
    directory_path = f'data/real_data/plots/n_{n}/h_{h}/binning/k_bins_{k}/diff_mouses_diff_classes'
    ensure_directory_exists(directory_path)
...
if __name__ == "__main__":
    ...
    while True:
        ...
        while check_par == 0:
            ...
            print(f"\nParameters: n={n}, h={h}, k_bins={k}")
            check_par = ensure_directory_exists2(f'data/real_data/n_{n}/h_{h}/binning/k_bins_{k}')

        data = import_all_data(n, h, k)
        # create a directory to save plots we are going to generate
        ensure_directory_exists(f'data/real_data/plots/n_{n}/h_{h}/binning/k_bins_{k}')
        # clean ks_results.txt
        clear_file(f'data/real_data/plots/n_{n}/h_{h}/binning/k_bins_{k}/ks_results.txt')
        # same mouse but different phase
        ...
        print(f'\nPlots for n={n}, h={h}, k_bins={k} have been created!')
